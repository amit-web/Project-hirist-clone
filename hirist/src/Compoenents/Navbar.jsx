  ...
  return (
    <>
      ...
      <Bottom>
        <p>Filter By:</p>
        <button>
          0-1 yrs <img height="7" src="icons8-chevron-down-30.png" alt="" />{" "}
        </button>
        <button>
          7 selected <img height="7" src="icons8-chevron-down-30.png" alt="" />
        </button>
        <button>
          Posting <img height="7" src="icons8-chevron-down-30.png" alt="" />
        </button>
        <Refine>
